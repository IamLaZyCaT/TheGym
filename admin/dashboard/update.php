...
<form action="process/resigter/update.php" method="POST" class="text-light border-light card bg-black p-5 register">
   <div class="row">
      <div class="col-lg-6 col-md-12">
         ...
         <br>
         <input type="hidden" name="id" id="id" value="<?php echo $data['Fname'];  ?>" > 
